            ...
            <section className={"Home"}>
                <div className={"description"}>
                    ...
                    <div className={"buttons"}>
                        <button className="btn"><a href="#DeployContract">Add Citizen</a></button>
                        <button className="btn"><a href="#InteractWithContract">Get Citizen</a></button>
                        <button className="btn"><a href="#InteractWithContract">Get Citizen Abroad</a></button>
                    </div>
                </div>
